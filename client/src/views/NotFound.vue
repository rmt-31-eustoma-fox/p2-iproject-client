...
<template>
    <div class="bg-gray-100 h-screen items-center pt-56 pb-56 justify-center">
        ...
        <center class="mt-6">
            <RouterLink href="{{url()->previous()}}"
                class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md" to="/">Go back </RouterLink>
        </center>
    </div>
</template>
