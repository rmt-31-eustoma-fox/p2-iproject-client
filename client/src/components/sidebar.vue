...
export default {
  emits: ["handleLogout"],
  computed: {
    ...mapState(useCounterStore, ["gempaterbaru"]),
  },
  methods: {
...
<template>
  <div id="perColumn">
    ...
    <aside class="w-64" aria-label="Sidebar">
      <div
        class="px-3 py-4 overflow-y-auto rounded bg-gray-50 dark:bg-gray-800 h-screen"
      >
        <ul class="space-y-2">
          <li>
            <router-link
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">MyTodo</span>
            </router-link>
          </li>
          <li>
            <router-link
        ...
        >
          <li>
            <button
              href="#"
              class="flex items-center p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg dark:text-white group"
            >
              <svg
                aria-hidden="true"
          ...
          <li>
            <a
              href="#"
              @click.prevent="this.$emit('handleLogout')"
        ...
        <div class="bg-white p-2 mt-2 text-center rounded-lg shadow-md">
          ...
          <div class="font-semibold mt-1">
            Coordinat : {{ gempaterbaru?.gempa?.Coordinates }}
          </div>
        </div>
      </div>
    </aside>
